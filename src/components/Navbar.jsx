...
const Navbar = ({ activeMenu }) => {
    ...
    return (
        <div className="flex items-center justify-between bg-white border-b border-gray-200/50 backdrop-blur-[2px] py-4 px-4 sm:px-6 sticky top-0 z-30">
            {/* Left side - menu button and title */}
            <div className="flex items-center gap-5">
                <button
                    onClick={() => setOpenSideMenu(!openSideMenu)}
                    className="flex items-center gap-2 text-black hover:bg-gray-100 p-1 rounded transition-colors lg:hidden"
                >
                    {openSideMenu ? (
